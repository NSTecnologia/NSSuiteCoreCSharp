...
namespace NSSuiteClientCSharp.Projetos.NFe.Requisições
{
    ...
    [JsonObject("NFe")]
    public partial class LayoutNFe : SolicitavelNaAPI, IEmissaoDFeSincrona
    {
        ...
        {
            string resposta = EnviaConteudoParaAPI(this, Endpoints.NFCeEnvio);
            return null; //JsonConvert.DeserializeObject<EnvioRespNFCe>(resposta);
        }
